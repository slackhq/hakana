...
use crate::{function_analysis_data::FunctionAnalysisData, scope::control_action};
...
pub(crate) fn get_control_actions(
    ...
    'outer: for stmt in stmts {
        ...
        if !stmt_control_actions.contains(&ControlAction::None) {
            return stmt_control_actions;
        }

        control_actions.extend(stmt_control_actions);
    }
