...
use hakana_code_info::{VarId, EFFECT_IMPURE_DB, EFFECT_WRITE_LOCAL, EFFECT_WRITE_PROPS};
                ...
                if let Some((params_key, param_value)) = arrayish_params {
                    ...
                    if offset_type_contained_by_expected {
                        ...
                        error_message = Some(format!(
                            ...
                            param.get_id(Some(&analysis_data.scoped_interner)),
                            arg_type.get_id(Some(&analysis_data.scoped_interner))
                        ));
                    }
                };
            }
