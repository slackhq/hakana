            ...
            analysis_data.maybe_add_issue(
                Issue::new(
                    ...
                    format!(
                        ...
                        array_type.get_id(Some(&analysis_data.scoped_interner)),
                        offset_type.get_id(Some(&analysis_data.scoped_interner))
                    ),
                    statements_analyzer.get_hpos(stmt.2),
                    &context.function_context.calling_functionlike_id,
                ),
                    ...
                    analysis_data.maybe_add_issue(
                        Issue::new(
                            ...
                            format!(
                                ...
                                vec.get_id(Some(&analysis_data.scoped_interner)),
                                val
                            ),
                    ...
                    if !allow_possibly_undefined {
                        ...
                        analysis_data.maybe_add_issue(
                            Issue::new(
                                ...
                                format!(
                                    "Fetch on {} using possibly-undefined key {}",
                                    dict.get_id(Some(&analysis_data.scoped_interner)),
...
pub(crate) fn handle_array_access_on_string(
    ...
    if !union_type_comparator::is_contained_by(
        ...
        expected_offset_types.push(valid_offset_type.get_id(Some(&analysis_data.scoped_interner)));
            ...
            analysis_data.maybe_add_issue(
                Issue::new(
                    ...
                    format!(
                        ...
                        mixed.get_id(Some(&analysis_data.scoped_interner))
                    ),
                    statements_analyzer.get_hpos(pos),
                    &context.function_context.calling_functionlike_id,
                ),
