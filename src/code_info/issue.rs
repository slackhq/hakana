...
impl IssueKind {
    pub fn from_str(str: &str, all_custom_issues: &FxHashSet<String>) -> Result<IssueKind, String> {
        match str {
            ...
            "ImpossibleTruthinessCheck" => Ok(IssueKind::ImpossibleTruthinessCheck),
            ...
            "InvalidInoutArgument" => Ok(IssueKind::InvalidInoutArgument),
            ...
            "MissingRequiredXhpAttribute" => Ok(IssueKind::MissingRequiredXhpAttribute),
            ...
            "RedundantIssetCheck" => Ok(IssueKind::RedundantIssetCheck),
            "RedundantNonnullTypeComparison" => Ok(IssueKind::RedundantNonnullTypeComparison),
            "RedundantTruthinessCheck" => Ok(IssueKind::RedundantTruthinessCheck),
