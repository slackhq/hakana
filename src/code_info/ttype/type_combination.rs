...
pub(crate) struct TypeCombination {
    ...
    pub enum_types: FxHashMap<StrId, (Option<Box<TAtomic>>, Box<TAtomic>)>,
    pub enum_value_types: FxHashMap<StrId, (usize, FxHashMap<StrId, (Option<Box<TAtomic>>, Box<TAtomic>)>)>,
